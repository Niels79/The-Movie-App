...
const ListsPage: React.FC = () => {
    ...
    const filteredSeenList = useMemo(() => {
        return userData.seenList?.filter(item => item && item.movie && item.movie.title.toLowerCase().includes(filterTerm.toLowerCase()))
