...
function App() {
  ...
  // De appTitle variabele is niet meer nodig hier
  // const appTitle = mediaType === 'movie' ? 'The Movie App' : 'The Series App';

  return (
    // De div hieronder heeft nu `pt-safe-top` voor iOS, maar we lossen het op met de hogere header.
    <div className="min-h-screen font-sans">
      <header className="bg-gray-800 p-4 shadow-md sticky top-0 z-20">
        <div className="container mx-auto flex justify-between items-center gap-4">
          
          {/* --- HIER IS DE TITEL AANGEPAST --- */}
          <div className="flex-grow min-w-0 font-bold text-white text-xl md:text-2xl leading-tight">
            <span className="block">The</span>
            <span className="block">{mediaType === 'movie' ? 'Movie' : 'Series'}</span>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-95 z-30 flex flex-col p-4 md:hidden">
            <div className="flex justify-between items-center mb-8">
                {/* De titel in het hamburgermenu kan ook op meerdere regels voor consistentie */}
